...
def launch_LoadAndSaveDepthtraining(**kwargs):

    # Launch training
    LoadandSaveDeptMap.LoadAndSaveDepthDepthMap(**kwa:q!rgs)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--WeighthPath', type=str, help="Weight path")
    ...
    # Launch training
    launch_LoadAndSaveDepthtraining(**d_params)
